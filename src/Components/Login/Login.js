        ...
        <div className="m-auto py-12 px-6 sm:p-20 xl:w-10/12">
          <div className="flex justify-center align-middle">
            <p className="font-medium text-3xl text-gray-600 text-center">
              Welcome to Razib Saha Studio ! <span className="text-blue-500"> Login.</span>
            </p>
          </div>
          ...
          <form action="" className="space-y-8 py-6">
            ...
            <div className="container mx-auto">
              ...
              <p className="text-sm text-center text-slate-600">Don't have an account?<Link to="/signup" type="reset" className="w-max p-3 -ml-3">
