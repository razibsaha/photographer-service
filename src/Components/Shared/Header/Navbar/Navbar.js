                  ...
                  <div class="flex flex-col h-full justify-between lg:items-center lg:flex-row">
                    <ul class="px-6 pt-32 text-gray-700 space-y-8 md:px-12 lg:space-y-0 lg:flex lg:space-x-12 lg:pt-0">
                      <li>
                        <Link
                          to="/home"
                          class="group relative before:absolute before:inset-x-0 before:bottom-0 before:h-2 before:bg-cyan-100 no-underline"
                        >
                      ...
                      <li>
                        ...
                        >
                          <span class="relative group-hover:text-cyan-800 no-underline">
                            Services
                          </span>
                        </Link>
                      </li>
                      ...
                      <li>
                        <Link
                          to="/about"
                          class="group relative before:absolute before:inset-x-0 before:bottom-0 before:h-2 before:origin-right before:scale-x-0 before:bg-cyan-100 before:transition before:duration-200 hover:before:origin-left active:bg-violet-700 hover:before:scale-x-100"
                        >
                          <span class="relative group-hover:text-cyan-800 no-underline active:bg-violet-700">
                            About us
                          </span>
                        </Link>
                      </li>
                    ...
                    <div class="border-t py-8 px-6 md:px-12 md:py-16 lg:border-t-0 lg:border-l lg:py-0 lg:pr-0 lg:pl-6">
                      {user ? (
                        <button className="block px-6 py-3 rounded-full bg-gradient-to-r from-sky-600 to-cyan-400 text-center text-white" onClick={handleSigOut}>
